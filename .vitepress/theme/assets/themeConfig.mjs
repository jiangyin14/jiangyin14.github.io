  ...
  nav: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "隐私政策", link: "/pages/privacy", icon: "lock" },
        { text: "版权协议", link: "/pages/cc", icon: "cc" },
      ],
    },
  ],
  // 导航栏菜单 - 左侧
  navMore: [
    {
      name: "站点",
      list: [
        { icon: "/images/logo/logo.webp", name: "博客首页", url: "/" },
        { icon: "/images/logo/logo.webp", name: "GitHub", url: "https://github.com/jiangyin14" },
      ],
    },
  ],
  // 封面配置
